...
<head>
    ...
    <title>GES-LOCATION | Ajouter un mode</title>
</head>
...
<body>
    ...
    <div id="container">
        <div id="space"></div>
        <form action="<?= parse('../../Controllers/Mode/Controller.php') ?>" method="POST" autocomplete="off" id="auth-form">
            <div class="div">
                    <h2>Ajouter un mode</h2>
            </div>
            <div class="div">
                <input type="text" name="libelle" id="libelle" class="div-input" minlength="3" maxlength="30"
                    placeholder="Libelle" required>
                <i class="fa fa-credit-card-alt"></i>
                <label for="libelle" class="label">Libelle</label>
            </div>
            <div class="div">
